...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
    ...
    ######
    #
    #WE will collude until the another person screws us OR someone else over, we will betray them from then on.     
    elif player == 1:
        if getting_team_name:
        ...
        if getting_team_name:
            ...
            if len(history) >=2:  
                if opponent_history[-2]==b:
                    return 'b' # betray if they were btrayed two times before
                else:
                    return 'c'
            else:
                return 'c' #otherwise collude
    ...
    #
        ...
        if getting_team_name:
            ...
            randomOptions = ["collude", "betray"]
            randomChoice = random.choice(randomOptions)
            if randomChoice == "collude":
                return 'c'
            elif randomChoice == "betray":
                return 'b'
